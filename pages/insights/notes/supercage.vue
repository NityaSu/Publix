  ...
  <main class="min-h-screen bg-background">
    <article class="w-full px-6 md:px-20 lg:px-[160px] py-16 md:py-24">
      ...
      <header class="max-w-3xl">
        ...
        <h1 class="mt-4 font-display font-extrabold text-white text-3xl sm:text-4xl md:text-5xl leading-tight">
          Building supercage: caging an AI coding agent
        </h1>
        <p class="mt-5 text-base md:text-lg text-muted leading-relaxed">
        ...
        <div class="mt-6 flex flex-wrap gap-2">
          <span
            ...
            :key="tag"
            class="font-dm text-[11px] uppercase tracking-[0.12em] text-muted border border-white/15 px-2.5 py-1"
          >
            {{ tag }}
          </span>
        </div>
        <div class="mt-8 h-[2px] w-full bg-accent" />
      </header>

      <div class="mt-12 md:mt-16 max-w-3xl space-y-6 text-sm md:text-base text-muted leading-relaxed">
        <!-- Intro -->
        <section aria-labelledby="why-heading" class="space-y-4">
          <h2 id="why-heading" class="font-display font-bold text-white text-xl md:text-2xl">
            Why this exists
          </h2>
          <p>
            Modern AI coding agents don’t just chat. Through
            <strong class="text-white/90 font-medium">tool calling</strong>
          ...
          <p>
            <strong class="text-white/90 font-medium">supercage</strong> is a learning project. The point is
        ...
        <section aria-labelledby="arch-heading" class="space-y-4 pt-4">
          <h2 id="arch-heading" class="font-display font-bold text-white text-xl md:text-2xl">
            Architecture (simple)
          </h2>
          <p>
            At a high level the loop is:
          </p>
          <ol class="list-decimal pl-5 space-y-2 text-muted">
            ...
            <li>
              ...
              <strong class="text-white/90 font-medium">workspace</strong>
              folder.
            </li>
            <li>
              Shell commands go through a
              <strong class="text-white/90 font-medium">sandbox</strong>
              — here, a throwaway Docker container with only <code class="text-accent/90">./workspace</code> mounted.
            </li>
            <li>
              Optional
              <strong class="text-white/90 font-medium">policies</strong>
              can deny a tool before it runs (for example, Shell Commands off).
            </li>
          </ol>
          <div
            class="mt-6 rounded-xl border border-white/10 bg-surface px-5 py-6 font-dm text-xs sm:text-sm text-white/80 leading-relaxed tracking-wide"
            role="img"
          ...
          <p>
            One more term:
            <strong class="text-white/90 font-medium">SSE</strong>
      ...
      <div class="mt-16 md:mt-20 max-w-4xl space-y-20 md:space-y-24">
        ...
        <section aria-labelledby="phase1-heading" class="space-y-6">
          <div class="max-w-3xl space-y-4">
            ...
            <h2 id="phase1-heading" class="font-display font-bold text-white text-2xl md:text-3xl">
              Unsafe CLI agent
            </h2>
            <p class="text-sm md:text-base text-muted leading-relaxed">
              What I built:
            </p>
            <ul class="list-disc pl-5 space-y-2 text-sm md:text-base text-muted leading-relaxed">
            ...
            <p class="text-sm md:text-base text-muted leading-relaxed">
              <strong class="text-white/90 font-medium">What it proves:</strong>
          ...
          <p class="max-w-3xl text-sm md:text-base text-white/80 leading-relaxed border-l-2 border-accent pl-4">
        ...
        <section aria-labelledby="phase2-heading" class="space-y-6">
          <div class="max-w-3xl space-y-4">
            ...
            <h2 id="phase2-heading" class="font-display font-bold text-white text-2xl md:text-3xl">
        ...
        <section aria-labelledby="phase3-heading" class="space-y-6">
          <div class="max-w-3xl space-y-4">
            ...
            <h2 id="phase3-heading" class="font-display font-bold text-white text-2xl md:text-3xl">
        ...
        <section aria-labelledby="phase4-heading" class="space-y-6">
          <div class="max-w-3xl space-y-4">
            ...
            <h2 id="phase4-heading" class="font-display font-bold text-white text-2xl md:text-3xl">
            ...
            <p class="text-sm md:text-base text-muted leading-relaxed">
              ...
              <em class="text-white/70">cage success</em>
              (command runs in Docker, host safe) is not the same as a
              <em class="text-white/70">policy BLOCK</em>
      ...
      <footer class="mt-20 md:mt-28 max-w-3xl space-y-8">
        ...
        <section aria-labelledby="learned-heading" class="space-y-4">
          <h2 id="learned-heading" class="font-display font-bold text-white text-xl md:text-2xl">
            What I learned
          </h2>
          <ul class="list-disc pl-5 space-y-2 text-sm md:text-base text-muted leading-relaxed">
        ...
        <section aria-labelledby="next-heading" class="space-y-4">
          <h2 id="next-heading" class="font-display font-bold text-white text-xl md:text-2xl">
            What’s next
          </h2>
          <ul class="list-disc pl-5 space-y-2 text-sm md:text-base text-muted leading-relaxed">
        ...
        <div class="pt-4 space-y-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center gap-2 px-6 py-3 rounded-none border border-accent font-dm font-bold text-sm uppercase tracking-[0.14em] text-white hover:bg-accent/10 hover:shadow-glow-sm transition-all duration-300"
          >
            View on GitHub
